    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .wzleft-c>*:nth-child(1){animation-delay:.08s}.wzleft-c>*:nth-child(2){animation-delay:.16s}.wzleft-c>*:nth-child(3){animation-delay:.24s}.wzleft-c>*:nth-child(4){animation-delay:.32s}.wzleft-c>*:nth-child(5){animation-delay:.40s}.wzleft-c>*:nth-child(6){animation-delay:.48s}.wzleft-c>*:nth-child(7){animation-delay:.56s}

        /* ── Right panel: flex column, no padding yet ── */
        .wzright{width:500px;flex-shrink:0;display:flex;flex-direction:column;align-items:stretch;justify-content:flex-start;padding:0;background:#071428;overflow-y:auto;position:relative}
        ...
        /* ── Login banner at top of right panel ── */
        .wz-login-banner{
          width:100%;background:linear-gradient(135deg,rgba(56,189,248,.07) 0%,rgba(14,165,233,.04) 100%);
          border-bottom:1px solid rgba(56,189,248,.13);padding:13px 52px;
          display:flex;align-items:center;justify-content:space-between;gap:12px;flex-shrink:0;
        }
        .wz-btn-login-banner{
          display:inline-flex;align-items:center;gap:7px;padding:9px 20px;border-radius:10px;
          border:1.5px solid rgba(56,189,248,.35);color:#38bdf8;font-size:13px;font-weight:700;
          text-decoration:none;white-space:nowrap;transition:all .2s;
          font-family:'Plus Jakarta Sans',sans-serif;background:transparent;
        }
        .wz-btn-login-banner:hover{background:rgba(56,189,248,.08);border-color:rgba(56,189,248,.6);transform:translateY(-1px)}
        ...
        .wz-login-card{
          width:100%;background:rgba(56,189,248,.04);border:1.5px solid rgba(56,189,248,.13);
          border-radius:16px;padding:18px 20px;display:flex;align-items:center;
          justify-content:space-between;gap:14px;
          transition:border-color .2s,background .2s;
        }
        .wz-login-card:hover{border-color:rgba(56,189,248,.28);background:rgba(56,189,248,.07)}
        .wz-btn-login-card{
          flex-shrink:0;display:inline-flex;align-items:center;gap:6px;
          padding:10px 18px;border-radius:10px;
          border:1.5px solid rgba(56,189,248,.35);color:#38bdf8;
          font-size:13px;font-weight:700;text-decoration:none;white-space:nowrap;
          transition:all .2s;font-family:'Plus Jakarta Sans',sans-serif;
        }
        .wz-btn-login-card:hover{background:rgba(56,189,248,.1);border-color:rgba(56,189,248,.6);transform:translateY(-1px)}

        @media(max-width:900px){
          .wzleft{display:none}
          .wzright{width:100%}
          .wz-login-banner{padding:12px 24px}
          .wz-form-area{padding:28px 24px 40px}
        }
        @media(max-width:440px){
          .wz-form-area{padding:24px 18px 36px}
          .wz-login-banner{flex-direction:column;text-align:center;gap:10px}
        }
      `}</style>
      ...
      <div className="wzpage">
        ...
        <div className="wzleft">
          ...
          <div className="wzleft-c" style={{ position:'relative', zIndex:1, maxWidth:400, width:'100%', textAlign:'center' }}>
            ...
            {/* Login CTA di panel kiri */}
            <Link href="/login" style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:8, padding:'13px 22px', borderRadius:14, border:'1.5px solid rgba(56,189,248,.3)', color:'#38bdf8', fontWeight:700, fontSize:14, textDecoration:'none', transition:'all .2s', marginBottom:20 }}
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(56,189,248,.08)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(56,189,248,.55)'; }}
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = 'transparent'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(56,189,248,.3)'; }}
            >
        ...
        <div className="wzright">
          ...
          {/* ── Banner "Sudah punya akun?" di atas form ── */}
          <div className="wz-login-banner">
            <div>
              <p style={{ fontSize:13, color:'#7ba3c0', fontWeight:500, marginBottom:2 }}>Sudah punya akun?</p>
              <p style={{ fontSize:12, color:'#3a5f80', fontWeight:400 }}>Masuk dan lanjutkan aktivitasmu</p>
            </div>
            <Link href="/login" className="wz-btn-login-banner">
              Masuk
            ...
            <div className={mounted ? 'wzform-c' : ''} style={{ width:'100%', maxWidth:384, display:'flex', flexDirection:'column', gap:0 }}>
              ...
              <div style={{ marginBottom:22 }}>
                ...
                <p style={{ fontSize:13.5, color:'#7ba3c0', fontWeight:500 }}>
                  Setup 5 menit · Tanpa kartu kredit · Langsung aktif
                </p>
              </div>
              ...
              {/* ── Login Card — menonjol di bawah form ── */}
              <div style={{ marginTop:24 }}>
                <div className="wz-login-card">
                  <div>
                    <p style={{ fontSize:14, color:'#f0f9ff', fontWeight:700, marginBottom:3 }}>Sudah punya akun? 👋</p>
                    <p style={{ fontSize:12.5, color:'#3a5f80', fontWeight:500, lineHeight:1.5 }}>Masuk dan lanjutkan kelola bio link kamu.</p>
                  </div>
                  <Link href="/login" className="wz-btn-login-card">
                    Masuk →
                  </Link>
                </div>
              </div>
