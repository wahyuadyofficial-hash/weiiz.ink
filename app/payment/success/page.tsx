    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">Terima kasih! Transaksimu telah dikonfirmasi.</p>
        </div>
            ...
            {order ? (
              <>
                ...
                <div className="flex items-start gap-2.5 bg-blue-50 rounded-xl px-3 py-3">
                  ...
                  <p className="text-xs text-blue-700">Konfirmasi pembelian dan link download telah dikirim ke emailmu.</p>
                </div>
              </>
            ) : (
