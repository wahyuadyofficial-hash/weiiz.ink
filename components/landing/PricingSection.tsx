...
const plans = [
  ...
  { name: "Pro", price: "99.000", fee: "1.5%", period: "/ bulan", badge: "PALING POPULER", popular: true, features: ["Unlimited link", "Unlimited produk digital", "Real-time analytics", "Custom domain sendiri", "AI bio generator âœ¨", "Withdrawal kapan saja"], cta: "Mulai Pro", href: "/register" },
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-4">
          ...
          <p className="text-white/40 text-lg max-w-xl mx-auto mb-1">
            ...
            <span className="text-white/70 font-semibold line-through decoration-red-500">10â€“15%</span>
          </p>
          <p className="text-emerald-400 font-semibold text-lg">Di Weiiz, mulai dari hanya 0.5% ðŸŽ‰</p>
        </div>
